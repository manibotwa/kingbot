...
module.exports = {
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By king kaviya😈' : process.env.ALL_CAPTION,
    ...
    BOTLIZA: process.env.BOT_NAME === undefined ? '  KINGKAVIYA😈  \n\n   *ωнαтsαρρ вσт™*   \n' : process.env.BOT_NAME,
    NOLOG: process.env.NO_LOG === undefined ? 'false' : process.env.NO_LOG,
    THERI_KICK: process.env.THERI_KICK === undefined ? 'false' : process.env.THERI_KICK,
    SONGD: process.env.SONGD === undefined ? '😈 *~Downloading your song~* 😈️' : process.env.SONGD,
    ...
    BOTV2: process.env.BOTV2_NAME === undefined ? '😈I AM KING KAVIYA😈' : process.env.BOTV2_NAME,
    BRANCH: 'master',
    HEROKU: {
